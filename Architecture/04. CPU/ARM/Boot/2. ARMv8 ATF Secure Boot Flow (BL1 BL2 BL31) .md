...
* (1)由于 ARMv8 规定, ARM core **复位**之后进入到当前系统支持**最高的异常等级**, 因此 **BL1** 运行在 **EL3**, 它执行完毕之后会通过 ERET 的方式跳转到 EL2, 当前 BL2 处于 S-EL1 异常等级, 可以见得, 从 BL1->BL2 这个过程, 属于降权过程 EL3->S/EL1(越过了 EL2 等级)
