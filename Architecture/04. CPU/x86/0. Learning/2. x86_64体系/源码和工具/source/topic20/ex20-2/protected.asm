...
;
;** ʵ�� 20-2����ӡ status��Ϣ�� stack
;

        finit                           ; ��ʼ�� x87 FPU
        fldz                            ; ���� 0.0
        fld1                            ; ���� 1.0
        fld DWORD [memfp32]             ; ����һ�� NaN ��
        fld DWORD [memfp32 + 4]         ; ����һ�� + infinity�����޾�����
        fld TWORD [memfp80]             ; ����һ�� denormal ��
        fxam                            ; ��鵱ǰ�� ST(0)״Ϣ
        call dump_x87_status            ; ��ӡ status
        call println
...
memfp32  dd 0x7fbfffff                  ; NaN ������
         dd 0x7f800000                  ; infinity ������
memfp80  dd 0xFFFFFFFF                  ; denormal ������
         dd 0x7FFFFFFF
         dw 0
