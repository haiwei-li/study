...
* [IRQs 的非早期初始化](linux-interrupts-8.md) - 这部分讲述了处理外部硬件中断的非早期初始化代码.
* [Softirq, Tasklets and Workqueues](linux-interrupts-9.md) - 这部分讲述了 softirqs、tasklets 和 workqueues 的内容.
