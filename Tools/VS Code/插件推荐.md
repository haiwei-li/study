...
- [4. C/C++](#4-cc)
  - [4.1. C/C++](#41-cc)
  - [4.2. C/C++ Advanced Lint](#42-cc-advanced-lint)
  - [4.3. Header Guard Generator](#43-header-guard-generator)
  - [4.4. Better C++ Syntax](#44-better-c-syntax)
- [5. Python](#5-python)
